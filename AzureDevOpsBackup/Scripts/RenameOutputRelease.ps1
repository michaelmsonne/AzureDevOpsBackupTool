...
if ($AzureDevOpsBackupFile) {
    ...
    $SearchPattern = "*AzureDevOpsBackup*Build at*.exe"
    ...
    $NewFileName = "{0} v. {1} - Build at {2}{3}" -f $AzureDevOpsBackupFile.BaseName, $FileVersion, (Get-Date -Format "ddMMyyyy-HHmmss"), $AzureDevOpsBackupFile.Extension
