...
- Added support for a new argument to create a 'real' Git clone of the repository with argument: '**--fullgitbackup**' - this will create a real Git clone of the repository instead of just a zip file or unzipped, so you can use the Git clone for further development or other purposes (optional)
